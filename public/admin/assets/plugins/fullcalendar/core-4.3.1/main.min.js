...
!(function(e, t) {
            ...
            return (
                (e.prototype.splitProps = function(e) {
                    var t = this,
                        ...
                        l = {};
                    for (var c in ((this.eventUiBuilders = Re(n, function(
                        e,
                        n
                    ) {
        ...
        for (
            var r = (function(e, t) {
                ...
                i = (function(e, t, n, r, i) {
                    ...
                    switch (t.type) {
                        case "PREV":
                            o = i.dateMemberGenerators[r].buildPrev(e, n);
                            break;
                        case "NEXT":
                            o = i.dateMemberGenerators[r].buildNext(e, n);
                            break;
                        case "SET_DATE":
                            (e.activeRange &&
                                Ze(e.currentRange, t.dateMarker)) ||
                                (o = i.dateMemberGenerators[r].build(
                                    t.dateMarker,
                                    void 0,
                                    !0
                                ));
                            break;
                        case "SET_VIEW_TYPE":
                            var a = i.dateMemberGenerators[r];
                            if (!a)
                                throw new Error(
                                    r
                    ...
                    return !o ||
                        ...
                        : o;
                    var s, u;
                })(e.dateMember, t, e.currentDate, r, n),
    ...
    var pr = (function(e) {
        ...
        hr = (function(e) {
            ...
            return (
                ...
                (t.prototype.render = function(e) {
                    this.freezeHeight();
                    var t = this.computeTitle(e.dateMember, e.viewSpec.options);
                    this._renderToolbars(
                        e.viewSpec,
                        e.dateMember,
                        e.currentDate,
                        e.dateMemberGenerator,
                        t
                    ),
                        this.renderView(e, t),
                        this.updateSize(),
        ...
        return (
                ...
                (!e && n) ||
                    ...
                    n.receiveProps(
                        Se({}, t, {
                            ...
                            dateMemberGenerator: this.dateMemberGenerators[r],
                            eventStore: a,
                            eventUiBases: l,
            ...
            (e.prototype.handleOptions = function(e) {
                ...
                (this.dateEnv = this.buildDateEnv(
                    ...
                    (this.dateMemberGenerators = Re(this.viewSpecs, function(
                        e
                    ) {
                        return new e.class.prototype.dateMemberGeneratorClass(
                            e,
                            t
                        );
                    }));
    ...
    var Mr = (function(e) {
        ...
        return (
            ...
            (t.prototype.render = function(e) {
                this.renderDatesMem(e.dateMember),
            ...
            (t.prototype.queryScroll = function() {
                var e = {};
                return (
                    this.props.dateMember && Se(e, this.queryDateScroll()), e
                );
            }),
            (t.prototype.applyScroll = function(e, t) {
                ...
                null != n &&
                    (delete e.duration,
                    this.props.dateMember && Se(e, this.computeDateScroll(n))),
                    this.props.dateMember && this.applyDateScroll(e);
            }),
    ...
    tn.mixInto(Mr),
        ...
        (Mr.prototype.dateMemberGeneratorClass = Jn);
    var kr = (function() {
        function e(e) {
            ...
            return (
                ...
                (t.prototype.render = function(e) {
                    ...
                    for (
                        ...
                        var s = a[o];
                        r.push(
                            Lr(s, e.dateMember, n, t.length, i, this.context)
                        );
                    }
