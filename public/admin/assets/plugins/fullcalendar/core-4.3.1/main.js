...
(function(global, factory) {
        ...
        switch (action.type) {
            ...
            case "ADD_EVENTS": // already parsed, but not expanded
                return addEvent(
                    ...
                    dateMember ? dateMember.activeRange : null,
                    calendar
                );
            case "MERGE_EVENTS": // already parsed and expanded
                return mergeEventStores(eventStore, action.eventStore);
            case "PREV": // TODO: how do we track all actions that affect dateMember :(
            case "NEXT":
            case "SET_DATE":
            case "SET_VIEW_TYPE":
                if (dateMember) {
    ...
    */
    ...
    function getDayClasses(date, dateMember, context, noThemeHighlight) {
        ...
        var todayStart;
        var todayEnd;
        if (!rangeContainsMarker(dateMember.activeRange, date)) {
            ...
            if (
                ...
                dateEnv.getMonth(date) !==
                    dateEnv.getMonth(dateMember.currentRange.start)
            ) {
    ...
    */
    var DateComponent = /** @class */ (function(_super) {
        ...
        */
        ...
        DateComponent.prototype.isInteractionValid = function(interaction) {
            ...
            var dateMember = this.props.dateMember; // HACK
        ...
        DateComponent.prototype.isDateSelectionValid = function(selection) {
            var dateMember = this.props.dateMember; // HACK
            if (
                dateMember && // HACK for DayTile
                !rangeContainsRange(dateMember.validRange, selection.range)
            ) {
                return false;
            }
    ...
    function reduceEventSources(eventSources, action, dateMember, calendar) {
        switch (action.type) {
    ...
    var DateMemberGenerator = /** @class */ (function() {
        function DateMemberGenerator(viewSpec, calendar) {
        ...
        DateMemberGenerator.prototype.buildPrev = function(
            currentDateMember,
            currentDate
        ) {
            ...
            var prevDate = dateEnv.subtract(
                dateEnv.startOf(
                    currentDate,
                    currentDateMember.currentRangeUnit
                ), // important for start-of-month
                currentDateMember.dateIncrement
            );
            return this.build(prevDate, -1);
        };
        // Builds a structure with info about what the dates/ranges will be for the "next" view.
        DateMemberGenerator.prototype.buildNext = function(
            currentDateMember,
            currentDate
        ) {
            var dateEnv = this.dateEnv;
        ...
        DateMemberGenerator.prototype.build = function(
            currentDate,
            direction,
            forceToValid
        ) {
        ...
        DateMemberGenerator.prototype.buildValidRange = function() {
            return (
        ...
        DateMemberGenerator.prototype.buildCurrentRangeInfo = function(
            date,
            direction
        ) {
            var _a = this,
        ...
        DateMemberGenerator.prototype.getFallbackDuration = function() {
            return createDuration({ day: 1 });
        };
        // Returns a new activeRange to have time values (un-ambiguate)
        // minTime or maxTime causes the range to expand.
        DateMemberGenerator.prototype.adjustActiveRange = function(
            range,
            minTime,
            maxTime
        ) {
        ...
        DateMemberGenerator.prototype.buildRangeFromDuration = function(
            date,
            direction,
            duration,
            unit
        ...
        DateMemberGenerator.prototype.buildRangeFromDayCount = function(
            date,
            direction,
            dayCount
        ) {
        ...
        DateMemberGenerator.prototype.buildCustomVisibleRange = function(date) {
            var dateEnv = this.dateEnv;
        ...
        // not responsible for trimming hidden days.
        DateMemberGenerator.prototype.buildRenderRange = function(
            currentRange,
            currentRangeUnit,
            isRangeAllDay
        ) {
        ...
        DateMemberGenerator.prototype.buildDateIncrement = function(fallback) {
        ...
        DateMemberGenerator.prototype.getRangeOption = function(name) {
            var otherArgs = [];
            for (var _i = 1; _i < arguments.length; _i++) {
        ...
        DateMemberGenerator.prototype.initHiddenDays = function() {
        ...
        DateMemberGenerator.prototype.trimHiddenDays = function(range) {
            var start = range.start;
            var end = range.end;
            if (start) {
        ...
        DateMemberGenerator.prototype.isHiddenDay = function(day) {
        ...
        DateMemberGenerator.prototype.skipHiddenDays = function(
            date,
            inc,
            isExclusive
        ) {
        ...
        return DateMemberGenerator;
    })();
    // TODO: find a way to avoid comparing DateMembers. it's tedious
    function isDateMembersEqual(p0, p1) {
        return (
    ...
    function reduce(state, action, calendar) {
        ...
        var dateMember = reduceDateMember(
            state.dateMember,
            action,
            state.currentDate,
            viewType,
    ...
    function reduceDateMember(
        ...
        switch (action.type) {
            case "PREV":
                newDateMember = calendar.dateMemberGenerators[
                    viewType
                ].buildPrev(currentDateMember, currentDate);
                break;
            case "NEXT":
                newDateMember = calendar.dateMemberGenerators[
                    viewType
                ].buildNext(currentDateMember, currentDate);
                break;
            case "SET_DATE":
                if (
                    !currentDateMember.activeRange ||
                    !rangeContainsMarker(
                        currentDateMember.currentRange,
                        action.dateMarker
                    )
                ) {
                    newDateMember = calendar.dateMemberGenerators[
                ...
                break;
            case "SET_VIEW_TYPE":
                var generator = calendar.dateMemberGenerators[viewType];
                if (!generator) {
                    throw new Error(
                        viewType
        ...
        if (
            newDateMember &&
            newDateMember.isValid &&
            !(
                currentDateMember &&
                isDateMembersEqual(currentDateMember, newDateMember)
            )
        ) {
            return newDateMember;
        } else {
            return currentDateMember;
        }
    }
    function reduceCurrentDate(currentDate, action, dateMember) {
        switch (action.type) {
            case "PREV":
            case "NEXT":
                if (
                    !rangeContainsMarker(dateMember.currentRange, currentDate)
                ) {
                    return dateMember.currentRange.start;
                } else {
                    return currentDate;
                }
            case "SET_DATE":
            case "SET_VIEW_TYPE":
                ...
                if (
                    dateMember.activeRange &&
                    !rangeContainsMarker(dateMember.activeRange, newDate)
                ) {
                    return dateMember.currentRange.start;
                } else {
                    return newDate;
    ...
    */
            ...
            if (buttonStr) {
                buttonStr.split(" ").forEach(function(buttonGroupStr, i) {
                    ...
                    if (groupChildren.length > 1) {
                        ...
                        var buttonGroupClassName = theme.getClass(
                            "buttonGroup"
                        );
    ...
    var CalendarComponent = /** @class */ (function(_super) {
        ...
        CalendarComponent.prototype.renderToolbars = function(
            ...
            var todayInfo = dateMemberGenerator.build(now);
            var prevInfo = dateMemberGenerator.buildPrev(
                dateMember,
                currentDate
            );
            var nextInfo = dateMemberGenerator.buildNext(
                dateMember,
                currentDate
            );
            var toolbarProps = {
                ...
                isTodayEnabled:
                    todayInfo.isValid &&
                    !rangeContainsMarker(dateMember.currentRange, now),
        ...
        CalendarComponent.prototype.renderView = function(props, title) {
            ...
            var viewSpec = props.viewSpec,
                dateMemberGenerator = props.dateMemberGenerator;
    ...
    function computeTitle(dateMember, viewOptions) {
        var range;
        // for views that span a large unit of time, show the proper interval, ignoring stray days before and after
        if (/^(year|month)$/.test(dateMember.currentRangeUnit)) {
            range = dateMember.currentRange;
        } else {
            // for day units or smaller, use the actual day range
            range = dateMember.activeRange;
        }
        return this.dateEnv.formatRange(
            range.start,
            range.end,
            createFormatter(
                viewOptions.titleFormat || computeTitleFormat(dateMember),
                viewOptions.titleRangeSeparator
            ),
            { isEndExclusive: dateMember.isRangeAllDay }
        );
    }
    // Generates the format string that should be used to generate the title for the current date range.
    // Attempts to compute the most appropriate format if not explicitly specified with `titleFormat`.
    function computeTitleFormat(dateMember) {
        var currentRangeUnit = dateMember.currentRangeUnit;
        if (currentRangeUnit === "year") {
            ...
            var days = diffWholeDays(
                dateMember.currentRange.start,
                dateMember.currentRange.end
            );
            if (days !== null && days > 1) {
    ...
    */
    ...
    var Calendar = /** @class */ (function() {
        ...
        Calendar.prototype.dispatch = function(action) {
            ...
            if (!this.isReducing) {
                ...
                if (
                    oldState.dateMember !== newState.dateMember ||
                    this.needsFullRerender
                ) {
                    if (oldState.dateMember && view) {
        ...
        */
        Calendar.prototype.renderComponent = function(needsFull) {
            ...
            component.receiveProps(
                __assign({}, state, {
                    viewSpec: viewSpec,
                    dateMember: state.dateMember,
                    dateMemberGenerator: this.dateMemberGenerators[viewType],
        ...
        Calendar.prototype.mutateOptions = function(
            ...
            this.batchRendering(function() {
                if (anyDifficultOptions) {
                    ...
                    but recomputes the state's dateMember
                    */
                    _this.dispatch({
                        type: "SET_VIEW_TYPE",
        ...
        */
        Calendar.prototype.handleOptions = function(options) {
            ...
            // ineffecient to do every time?
            this.dateMemberGenerators = mapHash(this.viewSpecs, function(
                viewSpec
            ) {
                return new viewSpec.class.prototype.dateMemberGeneratorClass(
                    viewSpec,
                    _this
                );
            });
    ...
    var View = /** @class */ (function(_super) {
        ...
        function View(context, viewSpec, dateMemberGenerator, parentEl) {
            var _this =
                _super.call(
                    this,
                    context,
            ...
            _this.dateMemberGenerator = dateMemberGenerator;
        ...
        Object.defineProperty(View.prototype, "activeStart", {
            ...
            get: function() {
                return this.dateEnv.toDate(
                    this.props.dateMember.activeRange.start
                );
            },
            enumerable: true,
            configurable: true
        ...
        Object.defineProperty(View.prototype, "activeEnd", {
            get: function() {
                return this.dateEnv.toDate(
                    this.props.dateMember.activeRange.end
                );
            },
            enumerable: true,
            configurable: true
        ...
        Object.defineProperty(View.prototype, "currentStart", {
            get: function() {
                return this.dateEnv.toDate(
                    this.props.dateMember.currentRange.start
                );
            },
            enumerable: true,
            configurable: true
        ...
        Object.defineProperty(View.prototype, "currentEnd", {
            get: function() {
                return this.dateEnv.toDate(
                    this.props.dateMember.currentRange.end
                );
            },
            enumerable: true,
            configurable: true
        ...
        View.prototype.render = function(props) {
            this.renderDatesMem(props.dateMember);
        ...
        // Date Rendering
        // -----------------------------------------------------------------------------------------------------------------
        View.prototype.renderDatesWrap = function(dateMember) {
            this.renderDates(dateMember);
            this.addScroll({
                duration: createDuration(this.opt("scrollTime"))
            });
            this.startNowIndicator(dateMember); // shouldn't render yet because updateSize will be called soon
        };
        View.prototype.unrenderDatesWrap = function() {
            this.stopNowIndicator();
            this.unrenderDates();
        };
        View.prototype.renderDates = function(dateMember) {};
        ...
        View.prototype.startNowIndicator = function(dateMember) {
            var _this = this;
            var dateEnv = this.dateEnv;
            var unit;
            var update;
            ...
            if (this.opt("nowIndicator")) {
                unit = this.getNowIndicatorUnit(dateMember);
                if (unit) {
        ...
        View.prototype.updateNowIndicator = function() {
            if (
                this.props.dateMember && // a way to determine if dates were rendered yet
        ...
        View.prototype.getNowIndicatorUnit = function(dateMember) {
    ...
    View.prototype.dateMemberGeneratorClass = DateMemberGenerator;
    ...
    */
    ...
    function renderDateCell(
        ...
        if (datesRepDistinctDays) {
            classNames = classNames.concat(
                ...
                getDayClasses(dateMarker, dateMember, context, true)
            );
        } else {
    ...
    var DaySeries = /** @class */ (function() {
        function DaySeries(range, dateMemberGenerator) {
            ...
            while (date < end) {
                ...
                if (dateMemberGenerator.isHiddenDay(date)) {
        ...
        Slicer.prototype._sliceEventStore = function(
            ...
            if (eventStore) {
                var rangeRes = sliceEventStore(
                    eventStore,
                    eventUiBases,
                    computeActiveRange(dateMember, Boolean(nextDayThreshold)),
                    nextDayThreshold
                );
                return {
    ...
    TODO: should be part of DateMember!
    TimelineDateMember already does this btw
    */
    function computeActiveRange(dateMember, isComponentAllDay) {
        var range = dateMember.activeRange;
        if (isComponentAllDay) {
            return range;
        }
        return {
            start: addMs(range.start, dateMember.minTime.milliseconds),
            end: addMs(range.end, dateMember.maxTime.milliseconds - 864e5) // 864e5 = ms in a day
        };
    }
    ...
    exports.DateMemberGenerator = DateMemberGenerator;
