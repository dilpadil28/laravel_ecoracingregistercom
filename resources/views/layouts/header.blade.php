                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li class="dropdown-header">
                            ...
                            <div class="d-inline-block">
                                @auth {{ Auth::user()->name }} @endauth<small class="pt-1">@auth
                                    {{ Auth::user()->email }} @endauth</small>
                            </div>
                        </li>

                        <li>
                            <a href="{{route('profiles.index')}}">
                                <i class="mdi mdi-account"></i> My Member
                            </a>
                        </li>

                        <li class="dropdown-footer">
                            <a href="{{ route('logout') }}" onclick="event.preventDefault();
                              document.getElementById('logout-form').submit();"> <i class="mdi mdi-logout"></i> Log Out
                            </a>
