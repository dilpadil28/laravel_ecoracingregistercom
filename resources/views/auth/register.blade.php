            ...
            <div class="col-lg-6 col-md-10">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <h4 class="text-dark mb-3">Register</h4>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12 mb-4">
                                    <input type="text" name="name"
                                        ...
                                        aria-describedby="nameHelp" placeholder="Name" value="{{ old('name') }}"
                                ...
                                <div class="form-group col-md-12 ">
                                    <input id="password-confirm" type="password" name="password_confirmation" required
                                        autocomplete="new-password" class="form-control input-lg " id="password"
                                        placeholder="Password Confirmation">
                                </div>
                                <div class="col-md-12">
                                    <button type="submit"
                                        class="btn btn-lg btn-primary btn-block mb-4">Register</button>
